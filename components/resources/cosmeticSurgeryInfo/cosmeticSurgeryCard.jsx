    ...
    <div className={styles.overlay}>
      <div className={styles.surgeryNavContainer}>
        ...
        onClick={() => onProcedureSelect("breastImplant")}>BREAST IMPLANT</h1>
            <h1 className={`${styles.navItem} ${selectedProcedure === "earPinning" ? styles.selected : ""}`} 
        onClick={() => onProcedureSelect("earPinning")}>EAR RESHAPING</h1>
            <h1 className={`${styles.navItem} ${selectedProcedure === "buttockLift" ? styles.selected : ""}`} 
        onClick={() => onProcedureSelect("buttockLift")}>BUTTOCK LIFT</h1>
        ...
        onClick={() => onProcedureSelect("liposuction")}>LIPOSUCTION</h1>
            <h1 className={`${styles.navItem} ${selectedProcedure === "eyelift" ? styles.selected : ""}`} 
        onClick={() => onProcedureSelect("eyelift")}>EYELID LIFT</h1>
