        ...
        <div className={styles.procedureContainer}>
          <div className={styles.bothGroups}>
            <div className={styles.tCardGroup1}>
              ...
              />
              <TreatmentCard
                onClick={() => handleClick("earPinning")}
                imageUrl="/resources/earPinning.webp"
                description="EAR PINNING"
              />
              <TreatmentCard
                onClick={() => handleClick("buttockLift")}
                imageUrl="/resources/buttockLift.webp"
                description="BUTTOCK LIFT"
              />
              <TreatmentCard
            ...
            <div className={styles.tCardGroup2}>
              ...
              />
              <TreatmentCard
                onClick={() => handleClick("eyeLift")}
                imageUrl="/resources/eyelidLift.webp"
                description="EYELIFT"
              />
              <TreatmentCard
